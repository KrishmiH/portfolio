          ...
          <div className="container">
            ...
            <div className="pt-10 xl:pt-16 flex gap-10 items-center justify-between">
              ...
              <div className="w-full lg:max-w-2xl flex-1">
                <p>
                  I am a passionate and dedicated undergraduate student with a
                  Bachelor's degree in Information Technology specializing in
                  Software Engineering. My skills include object-oriented
                  programming, software debugging, web programming, requirements
                  gathering and analysis, as well as problem solving and UI/UX
                  design. I pride myself on my strong communication skills and
                  my ability to work effectively in a team. I am eager to
                  continue expanding my knowledge and experience in the field of
